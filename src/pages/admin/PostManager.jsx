...
export default function PostManager() {
  ...
  // --- UPDATED: Properly handles drafts by opening them in preview mode ---
  const handleViewPost = (post) => {
    if (post.published) {
      window.open(`/blog/${post.slug}`, "_blank");
    } else {
      window.open(`/admin/posts/edit/${post.id}?preview=true`, "_blank");
    }
  };
                    ...
                    >
                      ...
                      <td className="px-6 py-4 text-right">
                        <div className="flex items-center justify-end gap-2">
                          ...
                          {/* UPDATED: Changed from Link to button so it triggers our Logic */}
                          <button
