...
import { ArrowRight, TrendingUp, Clock, Eye, Sparkles, Code2, Cpu } from "lucide-react";
...
export default function Home() {
  ...
  return (
    <div className="min-h-screen">
      <SEO 
        title="Home" 
        description="Welcome to the hub for VLSI Physical Design by Mr. Dhaval Shukla. Explore expert tutorials, industry projects, and career advice for semiconductor engineers."
      />
      {/* Hero Section */}
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-base md:text-lg text-gray-600 font-body mb-8 leading-relaxed max-w-2xl mx-auto lg:mx-0">
                Crafting AI chips at the nanometer scale. Sharing knowledge on VLSI design, EDA tools, physical design flows, and semiconductor engineering careers.
              </p>
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4">
                <Link
                  ...
                  data-testid="hero-explore-blog-button"
                >
                  Explore Blog
            ...
            >
              ...
              <div className="relative w-[15rem] md:w-[25rem] mx-auto">
                ...
                <motion.div
                  ...
                  className="absolute -top-4 -right-4 bg-white p-3 rounded-xl shadow-lg border border-gray-200"
                >
                ...
                <motion.div
                  ...
                  className="absolute top-1/3 -left-6 bg-white p-3 rounded-xl shadow-lg border border-gray-200"
                >
                ...
                <motion.div
                  ...
                  className="absolute bottom-20 -right-6 bg-white p-3 rounded-xl shadow-lg border border-gray-200"
                >
                ...
                <div className="relative">
                  ...
                  <div className="relative bg-white rounded-3xl shadow-2xl p-3 border-2 border-gray-100">
                    <div className="relative rounded-2xl overflow-hidden aspect-square bg-gradient-to-br from-blue-50 to-purple-50">
                      <img
                        src="https://tzaxthrqwfgbrcqmtuec.supabase.co/storage/v1/object/public/images/dhavalshukla.jpg"
                        alt="Dhaval Shukla - VLSI Design Engineer"
        ...
        <div className="max-w-6xl mx-auto">
          <div className="flex items-center justify-between mb-10">
            <div>
              ...
              <p className="text-gray-600 font-body">
                Latest tutorials and guides on VLSI design
              </p>
            </div>
            <Link
              to="/blog"
          ...
          {loading ? (
            <div className="grid md:grid-cols-3 gap-6">
              {[1, 2, 3].map((i) => (
                <div key={i} className="bg-white rounded-xl p-6 border border-gray-200 shimmer h-64"></div>
              ))}
            </div>
          ) : (
            <div className="grid md:grid-cols-3 gap-6">
              {featuredPosts.map((post, index) => (
                ...
                >
                  <Link
                    to={`/blog/${post.slug}`}
                    className="block bg-white rounded-xl overflow-hidden border border-gray-200 hover:shadow-xl transition-all duration-300 card-hover group h-full"
                  ...
                  >
                    ...
                    <div className="p-6">
                      ...
                      <p className="text-gray-600 text-sm font-body line-clamp-2 mb-3">
                        {post.excerpt}
                      </p>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-gradient-to-br from-blue-600 via-purple-600 to-pink-600 rounded-2xl p-10 md:p-16 text-center text-white shadow-2xl">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <Link
                to="/resources"
                className="px-8 py-3 bg-white text-blue-600 rounded-lg font-semibold hover:shadow-lg transition-all duration-200"
                data-testid="cta-resources-button"
              >
                Browse Resources
              </Link>
              <Link
                to="/contact"
                className="px-8 py-3 bg-transparent border-2 border-white text-white rounded-lg font-semibold hover:bg-white/10 transition-all duration-200"
